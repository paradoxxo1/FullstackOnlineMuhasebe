...
public class LogService : ILogService
{
    ...
    public LogService(IContextService contextService, ILogCommandRepository logCommandRepository, ICompanyDbUnitOfWork unitOfWork, ILogQueryRepository logQueryRepository, UserManager<AppUser> userManager)
    {
    ...
    public async Task<PaginationResult<LogDto>> GetAlByTableName(GetLogsByTableNameQuery request)
    {
