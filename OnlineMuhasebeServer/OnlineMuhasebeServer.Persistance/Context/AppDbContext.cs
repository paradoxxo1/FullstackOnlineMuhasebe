    ...
    public sealed class AppDbContext : IdentityDbContext<AppUser, AppRole, string>
    {
        ...
        public class AppDbContextFactory : IDesignTimeDbContextFactory<AppDbContext>
        {
            public AppDbContext CreateDbContext(string[] args)
            {
                ...
                var connectionString = "Data Source=DESKTOP-0E4KP6A\\SQLEXPRESS;Initial Catalog=MuhasebeMasterDb;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False";
