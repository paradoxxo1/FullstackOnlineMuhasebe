...
public sealed class CreateUserAndCompanyRLCommandHandler : ICommandHandler<CreateUserAndCompanyRLCommand, CreateUserAndCompanyRLCommandResponse>
{
    ...
    {
        UserAndCompanyRelationship entity = await
            _userAndCompanyRelationshipService.GetByUserIdAndCompanyId(request.AppUserId, request.CompanyId, cancellationToken);
